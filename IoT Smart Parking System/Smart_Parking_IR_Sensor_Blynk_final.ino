...
#define BLYNK_TEMPLATE_ID "TMPL5V4VXoZS"
#define BLYNK_DEVICE_NAME "IoT Parking Assistance System"
//#define BLYNK_AUTH_TOKEN ofnm65C_KFcMMT9fMuzePOOSMhwLb93i
#include <WiFi.h>
#include <WiFiClient.h>
#include <BlynkSimpleEsp32.h>

char auth[] = "ofnm65C_KFcMMT9fMuzePOOSMhwLb93i";//Paste auth token you copied
...
void sendSensor()
{
  ...
  Serial.print("s3=");
  Serial.println(s3);
   Blynk.virtualWrite(V1, s2); // select your virtual pins accordingly
  Blynk.virtualWrite(V0, s1); // select your virtual pins accordingly
    Blynk.virtualWrite(V2, s3); // select your virtual pins accordingly
 if(s1==4095)
