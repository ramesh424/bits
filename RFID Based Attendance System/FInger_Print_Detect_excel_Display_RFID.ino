...
if( ! mfrc522.PICC_IsNewCardPresent()){
  ...
  if(content.substring(1) == "7A 3A 95 19"){
    ...
    ID = "20071A0424";
    makeIFTTTRequest();
    Serial.println("Raghavendra");
    display.setCursor(2, 2);
    display.clearDisplay();
    display.println("Raghavendra-2nd Year ECE-A");
    display.display();
    Serial.println();
    delay(1000);
  }
    ...
    display.clearDisplay();
    display.println("Prashanth-2nd Year ECE-A");
    display.display();
    Serial.println();
    delay(1000);
  }
